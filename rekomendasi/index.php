    ...
    <div class="container mt-3">
        ...
        <div class="d-flex">
            <div class="card me-5" style="width: 18rem;">
                ...
                <a href="create.php" class="btn btn-primary mx-1 mb-1">Tambah Data Rekomendasi Belajar</a>
            </div>
        </div>
            ...
            <table id="example" class="display" style="width:100%">
                ...
                <tbody>
                    ...
                    <?php 
                        ...
                        $enkripsi = enkripsi($data['idrekomendasi']) 
                    ?>
                        <tr>
                            <td><?= $i; ?></td>
                            <?php
                                $idmodel = $data['idmodel'];
                                $model = query("SELECT * FROM model WHERE idmodel = $idmodel") [0];
                            ?>
                            <td><?= $model['model']; ?></td>
                            <td><?= $data['rekomendasi']; ?></td>
                            <td>
                                <a href="edit.php?id=<?= $enkripsi; ?>" class="btn btn-success btn-sm">Edit</a>
                                <button class="btn btn-danger btn-sm" id="delete" onclick="confirmDelete(<?= $data['idrekomendasi']; ?>)">Hapus</button>
                            </td>
                        </tr>
                    <?php $i++; ?>
                    <?php endforeach; ?>
        ...
        function confirmDelete(id) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '../controller/rekomendasiController.php',
                        type: 'POST',
                        data: {
                        action: 'delete',
                        id: id
                    ...
                    success: function(response) {
                        ...
                        Swal.fire({
                            icon : 'success',
                            title: 'Data Rekomendasi Belajar Berhasil Dihapus!',
